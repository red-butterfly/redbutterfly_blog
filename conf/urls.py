...
from red import index_views,article_views,serializers_views
from django.conf.urls import handler404,handler500

handler404 = "red.index_views.page_not_found"
handler500 = "red.index_views.page_error"
...
urlpatterns = [
    ...
    url(r'^restframework/article/',serializers_views.ArticleList_Re.as_view()),
]
